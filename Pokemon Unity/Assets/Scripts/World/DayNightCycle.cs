...
public class DayNightCycle : MonoBehaviour
{
    ...
    private static Color FullBright = new Color(1, 1, 1, 1);

    public DayNightCycle() => Instance = this;

    public bool modifyLight = true;
    ...
    void Start()
    {
        ...
        skyLight = new Color[24]
        {
            ...
            new Color(0.63f, 0.75f, 1, 1), new Color(0.63f, 0.75f, 1, 1), FullBright, FullBright,
            FullBright, FullBright, FullBright, FullBright,
            FullBright, FullBright, new Color(0.94f, 0.67f, 0.43f, 1),
    ...
    public void EnterIndoorArea()
    {
        modifyLight = false;
        modifyAmbientLight = false;
        RenderSettings.ambientLight = FullBright * .8f;
        RefreshLightColor(FullBright);
    }

    public void ExitIndoorArea()
    {
        modifyLight = true;
        modifyAmbientLight = true;
        RefreshLightColor(currentLight);
    }

    private void RefreshLightColor(Color color)
    {
        lightSource.color = color * filter;
        ...
        while (true)
        {
            ...
            if (modifyLight)
            {
                if (!debugIgnoreTime)
                {
                    ...
                    RefreshLightColor(new Color(r, g, b, 1));
